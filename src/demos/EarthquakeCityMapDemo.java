...
/** EarthquakeCityMapDemo An application with an interactive map displaying earthquake data. Author:
...
public class EarthquakeCityMapDemo extends PApplet {
    ...
    public void setup() {
        ...
        // map= new UnfoldingMap(this, 200, 50, 700, 500, new Yahoo.YahooProvider ());
