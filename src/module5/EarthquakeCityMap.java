...
//        if (lastSelected != null) { return; }
    ...
    public void mouseClicked() {
        ...
        if (lastClicked != null) {
            ...
            checkMarkerClick(cityMarkers);
            checkMarkerClick(quakeMarkers);
    ...
    private void checkMarkerClick(List<Marker> markers) {
    ...
    private void hideCityMarkers(List<Marker> cities) {
        for (Marker city : cities) {
            if (city.getDistanceTo(lastClicked.getLocation()) > ((EarthquakeMarker) lastClicked)
                .threatCircle()) {
                city.setHidden(true);
            } else {
    ...
    private void hideQuakeMarkers(List<Marker> quakes) {

        for (Marker quake : quakes) {
            if (quake.getDistanceTo(lastClicked.getLocation()) > ((EarthquakeMarker) quake)
                .threatCircle()) {
