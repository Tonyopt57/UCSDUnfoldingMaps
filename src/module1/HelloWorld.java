...
/** HelloWorld An application with two maps side-by-side zoomed in on different locations. Author:
 * UC San Diego Coursera Intermediate Programming team
 *
 * @author Your name here Date: July 17, 2015 */
public class HelloWorld extends PApplet {
    /** Your goal: add code to display second map, zoom in, and customize the background. Feel free
     * to copy and use this code, adding to it, modifying it, etc. Don't forget the import lines
     * above. */
    ...
    public void setup() {
        ...
        map2.zoomAndPanTo(zoomLevel, new Location(22.92f, 113.36f));
